...
{
    [Theory]
    [InlineData("Essential Monthly", GardenSize.Small, 20.00)]
    [InlineData("Premium Monthly", GardenSize.Medium, 30.00)]
    [InlineData("Elite Monthly", GardenSize.Large, 40.00)]
    public void Per_visit_rate_by_garden_size(string planName, GardenSize gardenSize, decimal expected)
    {
        _ = planName;
